...
class HTTPNtlmAuthHandler(AbstractNtlmAuthHandler, urllib2.request.BaseHandler):
...
class ProxyNtlmAuthHandler(AbstractNtlmAuthHandler, urllib2.request.BaseHandler):
    """
